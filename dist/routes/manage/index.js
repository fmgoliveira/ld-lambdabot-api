...
router.get('/:guildId/leave', middlewares_1.isAuthenticated, middlewares_1.isAllowed, middlewares_1.storedGuildSetup, manage_1.getLeaveSettingsController);
...
router.get('/:guildId/autoroles', middlewares_1.isAuthenticated, middlewares_1.isAllowed, middlewares_1.storedGuildSetup, manage_1.getAutorolesSettingsController);
...
router.get('/:guildId/alt-detection', middlewares_1.isAuthenticated, middlewares_1.isAllowed, middlewares_1.storedGuildSetup, manage_1.getAltDetectionSettingsController);
...
router.get('/:guildId/chat-filter', middlewares_1.isAuthenticated, middlewares_1.isAllowed, middlewares_1.storedGuildSetup, manage_1.getChatFilterSettingsController);
